<?php
    ...
    if (!isset($_SESSION['id'])) {
        ...
        if(isset($_GET['del']))
        {
            ...
            header("location: view_celebrities_gallery.php");
        }
?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img alt="Service 1" src="uploads/gallery/celebrities/<?php echo htmlentities($row['images']);?>" style="height: 60px;" />
                                            </td>
                                             <td><?php echo ($row['imagename']);?></td>
                                            <!-- <td><?php //echo ($row['service_name']);?></td>
                                            <td><?php //echo ($row['content']);?></td> -->
                                            <td class="item-actions-block">
                                                <a class="remove" href="view_celebrities_gallery.php?id=<?php echo $row['id'];?>&del=delete" onclick="return confirm('Are you sure you want to delete this item?');">
