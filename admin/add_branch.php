<?php
    ...
    if (!isset($_SESSION['id'])) {
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO branch (branch_name,address,link_address) VALUES('$branch_name','$address','$link_address')";
            ...
            <div class="col-md-10 mx-auto">
                <div class="card card-block sameheight-item">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="title-block">
                            <h1 class="title"> Add Branch Here </h1>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="example-text-input" class="control-label">Address Link</label>
                            <input class="form-control boxed" type="text" name="link_address" required>
                        </div>
                        <div class="form-group">
