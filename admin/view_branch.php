...
<?php include "header.php"; ?>
	<article class="content responsive-tables-page">
	    <div class="title-block">
	        <h1 class="title"> View Branches Information</h1>
	    </div>
	                ...
	                <div class="card">
	                    <div class="card-block">
	                        <div class="card-title-block">
	                            <h3 class="title"> Branches in Tabular Form</h3>
	                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($row['link_address']);?></td>
                                             <td class="item-actions-block">
                                                <a class="remove" href="view_branch.php?id=<?php echo $row['id'];?>&del=delete" onclick="return confirm('Are you sure you want to delete this item?');">
