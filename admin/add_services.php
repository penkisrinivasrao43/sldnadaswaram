<?php
    ...
    if (!isset($_SESSION['id'])) {
        ...
        if(isset($_POST['submit'])){
            ...
            $upload_dir = 'uploads/services/'.DIRECTORY_SEPARATOR;
            ...
            $sql = "INSERT INTO services(service_name,cover_image,content) VALUES('$service_name','$image','$content')";
            ...
            <div class="col-md-10 mx-auto">
                <div class="card card-block sameheight-item">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="title-block">
                            <h1 class="title"> Add Information Here </h1>
                        </div>
                        <div class="form-group">
                            <label for="example-text-input" class="control-label">Service Name</label>
                            <input class="form-control boxed" type="text" name="service_name" required>
                        </div>
