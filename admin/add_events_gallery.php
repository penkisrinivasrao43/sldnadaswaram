...
if (!isset($_SESSION['id'])) {
    ...
    if(isset($_POST['submit'])){
         ...
         //  echo $res['0'];
            ...
            //              $var=$fileName;
                        move_uploaded_file($_FILES["image"]["tmp_name"],"uploads/gallery/events/".$_FILES["image"]["name"]);
                         $res = mysqli_query($conn,"INSERT INTO events(images,imagename)VALUES('$image','$imagename')") or die("query failed");
...
//         $dir = "uploads/gallery/events/";
//         if (!is_dir($dir)) {
//             mkdir("uploads/gallery/events/");
//         }
//         $path = 'uploads/gallery/events/';
//         // Velidate if files exist
//         if (!empty(array_filter($_FILES['fileUpload']['name']))) {
//             // Loop through file items
//             foreach ($_FILES['fileUpload']['name'] as $id => $val) {
...
//                         $sqlVal = "('" . $fileName . "', '" . $uploadDate . "')";
//                         $var = $fileName;
//                         ($res = mysqli_query($conn, "INSERT INTO events (images)VALUES('$var')")) or die("query failed");
//                         // //  echo $var;
//                         // $totalfiles = count($_FILES['fileUpload']['name']);
//                         // echo $_FILES['fileUpload']['name'][$id];
//                         //    $sql="INSERT INTO `celebrities`(`id`, `images`) VALUES ('$id','$var')"OR die("Query FAILED");
            ...
            <div class="col-md-6">
                <div class="card card-block sameheight-item">
                    <div class="title-block">
                        <h3 class="title"> Add Events Gallery Images </h3>
                    </div>
