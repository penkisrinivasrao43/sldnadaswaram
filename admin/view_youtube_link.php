<?php
    ...
    if (!isset($_SESSION['id'])) {
        ...
        {
            $id = $_GET["id"];
            $sql = "DELETE FROM where youtube WHERE id ='$id'";
...
<?php include "header.php"; ?>
	<article class="content responsive-tables-page">
	    <div class="title-block">
	        <h1 class="title"> View Youtube Link Information</h1>
	    </div>
	                ...
	                <div class="card">
	                    <div class="card-block">
	                        <div class="card-title-block">
	                            <h3 class="title"> Youtube Link in Tabular Form</h3>
	                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo ($row['youtube_link']);?></td>
                                             <td class="item-actions-block">
                                                <a class="remove" href="dellinkk.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');">
