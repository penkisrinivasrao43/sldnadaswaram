                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img alt="Event" src="uploads/event_type/<?php echo htmlentities($row['image']);?>" style="height: 100px;" />
                                            </td>
                                            <td><?php echo ($row['event_heading']);?></td>
                                            <td><?php echo ($row['content']);?></td>
                                            <td class="item-actions-block">
                                                <a class="remove" href="view_event_type.php?id=<?php echo $row['id'];?>&del=delete" onclick="return confirm('Are you sure you want to delete this item?');">
                                                    <i class="fa fa-trash-o "></i>
                                                </a>&nbsp;
                                                <a class="edit" href="edit_event_type.php?id=<?php echo $row['id']?>">
